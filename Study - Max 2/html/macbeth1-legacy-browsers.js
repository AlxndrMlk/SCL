...
function relationship_scaleRoutineBegin(trials) {
  return function () {
    ...
    relationship_scaleComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function preMFQ_instrRoutineBegin(trials) {
  return function () {
    ...
    preMFQ_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function MFQ1RoutineBegin(trials) {
  return function () {
    ...
    MFQ1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function MFQ2RoutineBegin(trials) {
  return function () {
    ...
    MFQ2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function manipulationRoutineBegin(trials) {
  return function () {
    ...
    manipulationComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function fakeiq_scale_instrRoutineBegin(trials) {
  return function () {
    ...
    fakeiq_scale_instrComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function fakeiq_scale2RoutineBegin(trials) {
  return function () {
    ...
    fakeiq_scale2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function demographyRoutineBegin(trials) {
  return function () {
    ...
    demographyComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function debriefingRoutineBegin(trials) {
  return function () {
    ...
    debriefingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
